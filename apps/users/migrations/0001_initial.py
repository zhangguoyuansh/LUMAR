    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birthday', models.DateField(blank=True, null=True, verbose_name='Data of Birth')),
                ('gender', models.CharField(choices=[('male', 'Male'), ('famale', 'famale')], default='male', max_length=10, verbose_name='Gender')),
                ('mobile', models.CharField(default='', max_length=11, verbose_name='mobile')),
                ('email', models.EmailField(max_length=100, verbose_name='email')),
                ('image', models.ImageField(blank=True, default='image/default.jpg', null=True, upload_to='image/%Y/%m')),
                ('post', models.CharField(blank=True, max_length=50, null=True, verbose_name='postion')),
                ('joined_date', models.DateField(blank=True, null=True, verbose_name='joined_date')),
            ],
            options={
