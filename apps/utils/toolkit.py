...
class SendMessage(object):
    ...
    def send_workorder_email(self, number):
        ...
        if work_order.status == "2":
            ...
            record = work_order.explorationapplicationrecord_set.filter(record_type="1").last()
            ...
            record = work_order.explorationapplicationrecord_set.filter(record_type="2").last()
            ...
            record = work_order.explorationapplicationrecord_set.filter(record_type="3").last()
            ...
            record = work_order.explorationapplicationrecord_set.filter(record_type="0").last()
