...
urlpatterns = [
    ...
    url(r'traditionalowner/$', views_bsm.CustomerView.as_view(), name="customer"),
    url(r'traditionalowner/list', views_bsm.CustomerListView.as_view(), name="customer-list"),
    url(r'traditionalowner/detail', views_bsm.CustomerDetailView.as_view(), name="customer-detail"),
    url(r'customer/delete', views_bsm.CustomerDeleteView.as_view(), name="customer-delete"),

    url(r'landtype/$', views_bsm.EquipmentTypeView.as_view(), name="equipmenttype"),
    url(r'landtype/list', views_bsm.EquipmentTypeListView.as_view(), name="equipmenttype-list"),
    url(r'landtype/detail', views_bsm.EquipmentTypeDetailView.as_view(), name="equipmenttype-detail"),
    url(r'landtype/delete', views_bsm.EquipmentTypeDeleteView.as_view(), name="equipmenttype-delete"),
